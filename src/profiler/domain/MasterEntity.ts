...
export class MasterCompanyModel {
    entity: EntityModel = new EntityModel()
    company: CompanyModel = new CompanyModel()
    client: ClientModel = new ClientModel()

    constructor() {
        this.entity.entityClass = EntityClass.MASTER
...
export class MasterPersonRecord {
    entity: EntityRecord = new EntityRecord()
...
export class MasterPersonModel {
    entity: EntityModel = new EntityModel()
